(function() {
  var Controller, matchRoute, merge, normalizePath, registerRoute, routeMethods, routes, zipObject;
  ...
  matchRoute = function(method, url, params, push) {
    var i, matches, obj, stopRoute, _ref, _results;
    if (params == null) {
      params = {};
    }
    _results = [];
    ...
    function Controller(base, scope) {
      ...
      routeMethods.forEach(function(method) {
        ...
        return router[method] = function(route, callback) {
          ...
          return registerRoute(method, base + route, filters, callback);
        };
      });
      ...
      router.after = function(filter) {
        return filters.after.push(filter);
      };
      scope(router);
